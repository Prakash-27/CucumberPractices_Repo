...
public class AmazonHomePage {
	...
	@Then("user can see more product by clicking on carousel")
	public void user_can_see_more_product_by_clicking_on_carousel() {
	...
	@Then("user gets all amazon servies links")
	public void user_gets_all_amazon_servies_links(DataTable dataTable) {
